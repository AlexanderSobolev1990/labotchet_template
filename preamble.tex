...
\usepackage{bookmark}
\usepackage{mfirstuc} % Для выдачи команды \capitalisewords{...} чтобы сделать первые буквы заглавными в словах

\newcommand{\intdelim}{,}%{;}%  разделитель интервала вида [0,360)
\newcommand{\enumlineending}{;} % команда знака препинания в конце строки перечисления
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\productcodefull}{АБВГ.01234} % Код организации + Регистрационный код
\title{Исследование чего-нибудь очень нужного и полезного для отечественной науки} 
\def\organizationname{ОАО~<<Название орагнизации>>}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\firstapplication{no_application} % Первое применение
...
%
% СОГЛАСОВАНО
%\customerrank{Начальник~ООО <<АБВГ>>~} % На одной стороке
\customerrank{~} % На двух строках
%\customername{\phantom{А.Б.~Заказчиков}} % \phantom - убирает видимость
\customername{~} % \phantom - убирает видимость

% УТВЕРЖДАЮ
\chiefconstructorrank{Начальник}%Главный конструктор\\изделия \productname\\н
\chiefconstructorname{А.Б.~Начальников}
%
\fromcustomerrank{От ~ заказчика}
\fromcustomername{\phantom{А.Б.~Заказчиков}} % \phantom - убирает видимость
%
%\headofdepartmentrank{~}
%\headofdepartmentname{~}
%
\deputyofchiefconstructorrank{Начальник отдела}
\deputyofchiefconstructorname{А.Б.~Отделов}
%
\headoflaboratoryrank{Начальник лаборатории}
\headoflaboratoryname{А.Б.~Лабораторский}
%
%\headoflaboratoryranksecond{Начальник лаборатории}
%\headoflaboratorynamesecond{А.Б.~Лабораторский}
%%
%\headoflaboratoryrankthird{Начальник лаборатории}
%\headoflaboratorynamethird{А.Б.~Лабораторский}
%
\developerrank{Инженер}
\developername{А.Б.~Инженерский}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Настройка нумерации рисунков, таблиц, формул внутри раздела/всего доумента
%
% Таблицы:
\makeatletter
...
% Рисунки:
\makeatletter
\renewcommand{\theillustration}{\wordrefimage\thesection.\@arabic\c@illustration}
\renewcommand{\theunderillustration}{\wordimage~\thesection.\@arabic\c@illustration}
